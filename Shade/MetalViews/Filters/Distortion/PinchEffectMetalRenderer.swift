//
//  PinchEffectMetalRenderer.swift
//  Shade
//
...
class PinchEffectMetalRenderer: NSObject,MTKViewDelegate {
    ...
    func setupPipeline() {
        ...
        let vertexFunction = library.makeFunction(name: "pinchEffectVertexShader")
        let fragmentFunction = library.makeFunction(name: "pinchEffectFragment")
...
struct PinchEffectMetalView: NSViewRepresentable {
    var image: NSImage
    ...
    class Coordinator: NSObject {
        ...
        var parent: PinchEffectMetalView
        var renderer: PinchEffectMetalRenderer
        
        init(_ parent: PinchEffectMetalView) {
            self.parent = parent
            let device = MTLCreateSystemDefaultDevice()!
            self.renderer =  PinchEffectMetalRenderer(device: device, image: parent.image)
        }
    }
}


struct PinchEffectView: View {
