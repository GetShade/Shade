...
class GrainMetalRenderer: NSObject,MTKViewDelegate {
    ...
    func setupPipeline() {
        ...
        let vertexFunction = library.makeFunction(name: "vertexOut")
        let fragmentFunction = library.makeFunction(name: "GrainFragmentShader")
    ...
    func draw(in view: MTKView) {
        ...
        renderEncoder.setFragmentBytes(&grainIntensity, length: MemoryLayout<Float>.size, index: 1)
