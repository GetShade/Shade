//
//  ColorMonochromeMetalRenderer.swift
//  Shade
//
...
class ColorMonochromeMetalRenderer: NSObject,MTKViewDelegate {
    ...
    var color =  SIMD4<Float>(0.0,0.0,0.0,0.0)
    ...
    func setupPipeline() {
        ...
        let vertexFunction = library.makeFunction(name: "monochromeVertexShader")
        let fragmentFunction = library.makeFunction(name: "monochromeFragmentShader")
    ...
    func draw(in view: MTKView) {
        ...
        renderEncoder.setFragmentBytes(&intensity, length: MemoryLayout<Float>.size, index: 1)
